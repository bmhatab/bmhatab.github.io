...
#### Applied Skills
- `Option Pricing`, `Greeks`, `Hedging Strategies`,`Financial Modeling`, `Risk Management`, `Market Analysis`, `Quantitative Analysis`.
...
#### Applied Skills
- `Data Preparation`, `Exploratory Data Analysis (EDA)`, `Variational Autoencoder (VAE) Modeling`, `Implied Volatility Analysis`, `Data Visualization`, `Python Programming`, `Machine Learning`, `Scikit-Learn`, `TensorFlow Libraries`
...
#### Applied Skills
- `Stochastic Differential Equations (SDEs)`, `Data Simulation`, `Reinforcement Learning (DDQN)`, `Statistical Arbitrage`, `Reward Distribution Analysis`, `Python Programming`, `Machine Learning`, `TensorFlow and Keras Libraries`.
